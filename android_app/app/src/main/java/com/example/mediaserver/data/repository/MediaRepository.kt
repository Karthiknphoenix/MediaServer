...
import com.example.mediaserver.data.remote.ProgressDto
import com.example.mediaserver.data.remote.CreateLibraryRequest
import com.example.mediaserver.data.remote.ListDirectoriesRequest
...
class MediaRepository @Inject constructor(
    ...
    suspend fun identifyMedia(id: Long, tmdbId: Long, mediaType: String?) = runCatching {
        api.identifyMedia(id, com.example.mediaserver.data.remote.IdentifyRequest(tmdbId, mediaType))
    }
    ...
    suspend fun updateRemoteSetting(key: String, value: String) = runCatching { 
        api.updateSetting(com.example.mediaserver.data.remote.UpdateSettingRequest(key, value)) 
    }
